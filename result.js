let apiKey='edf8f831eb3e5973bfeee0798b5e92c8'
...
async function fetchWeatherData(latitude, longitude) {
    ...
    const apiUrl = `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=edf8f831eb3e5973bfeee0798b5e92c8&units=metric`;
